import type { DataFactory, NamedNode, BlankNode } from '@rdfjs/types';

import { DefaultDataFactory } from './rdf/rdf-model.js';
import { ShapeBuilder, definesType, computedProperty, property, self, transient } from './builder.js';
import {
...
import { rdf, xsd, makeRampVocabulary } from './vocabulary.js';
...
export function makeJsonShapesForShapes(factory: DataFactory = DefaultDataFactory) {
